...
class _ButtonState extends State<Button> {
  ...
  Widget build(BuildContext context) {
    ...
    final padding = widget.title != null
        ? switch (widget.size) {
            ButtonSize.large => EdgeInsets.symmetric(horizontal: widget.horizontalPadding ?? 32),
            ButtonSize.medium ||
            ButtonSize.small =>
                ...
                children: [
                  ...
                  Text(
                    ...
                    style: switch (widget.size) {
                      ButtonSize.large => context.textStyle.buttonLarge.copyWith(
                          color: widget.foreground,
                        ),
                      ButtonSize.medium => context.textStyle.buttonMedium.copyWith(
                          color: widget.foreground,
                        ),
                      ButtonSize.small => context.textStyle.buttonSmall.copyWith(
                          color: widget.foreground,
                        ),
                      ButtonSize.extraSmall => context.textStyle.buttonExtraSmall.copyWith(
                          color: widget.foreground,
                        ),
                    },
                  ),
        ...
        return TextButton(
          ...
          style: ButtonStyle(
            ...
            textStyle: MaterialStateProperty.resolveWith<TextStyle>(
              (states) => context.textStyle.buttonMedium.copyWith(color: foreground),
            ),
            shape: MaterialStateProperty.all(
              RoundedRectangleBorder(
                borderRadius: BorderRadius.circular(radius),
