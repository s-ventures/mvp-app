...
export 'erp/details/attachments.dart';
export 'erp/details/category.dart';
export 'erp/details/client.dart';
export 'erp/details/dates.dart';
export 'erp/details/header.dart';
export 'erp/details/link.dart';
export 'erp/details/movement.dart';
export 'erp/details/products.dart';
