...
import 'package:manifiesto_mvp_app/application/daily_banking/insurances/policies/detailed/detailed_policy_state.dart';
import 'package:manifiesto_mvp_app/infrastructure/insurances/policies/repositories/policies_repository.dart';
...
class DetailedPolicyController extends StateNotifier<DetailedPolicyState> {
  ...
  Future<void> init(
      {required int insuranceId, required String policyId}) async {
    try {
