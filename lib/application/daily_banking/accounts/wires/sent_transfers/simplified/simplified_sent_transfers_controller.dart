...
import 'package:manifiesto_mvp_app/infrastructure/wires/sent_transfers/repositories/sent_transfers_pagination_repository.dart';

final simplifiedSentTransfersControllerProvider = StateNotifierProvider<
...
class SimplifiedSentTransfersController
    extends StateNotifier<SimplifiedSentTransfersState>
  ...
  Future<void> initLastSentTransfers() async {
    try {
      final lastSentTransfers =
          await _repository.fetchPage(page: 0, pageSize: 5);
      setStateSafe(
