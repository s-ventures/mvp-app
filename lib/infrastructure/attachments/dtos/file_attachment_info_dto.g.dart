...
_$FileAttachmentInfoDtoImpl _$$FileAttachmentInfoDtoImplFromJson(Map<String, dynamic> json) =>
...
Map<String, dynamic> _$$FileAttachmentInfoDtoImplToJson(_$FileAttachmentInfoDtoImpl instance) =>
    <String, dynamic>{
