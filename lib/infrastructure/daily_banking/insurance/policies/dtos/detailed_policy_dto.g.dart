...
_$DetailedPolicyDtoImpl _$$DetailedPolicyDtoImplFromJson(Map<String, dynamic> json) =>
    _$DetailedPolicyDtoImpl(
      ...
      paymentPeriodicity:
          $enumDecode(_$PolicyPaymentPeriodicityDtoEnumMap, json['paymentPeriodicity']),
    );

Map<String, dynamic> _$$DetailedPolicyDtoImplToJson(_$DetailedPolicyDtoImpl instance) =>
    <String, dynamic>{
