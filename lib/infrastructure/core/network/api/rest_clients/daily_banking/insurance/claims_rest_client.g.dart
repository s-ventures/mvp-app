...
part of 'claims_rest_client.dart';
...
class _ClaimsRestClient implements ClaimsRestClient {
  _ClaimsRestClient(
    this._dio, {
    this.baseUrl,
  });
  ...
  Future<PaginatedResponse<SimplifiedClaimDto>> getSimplifiedClaims(
      {required ClaimsFilterDto filter}) async {
    ...
    final value = PaginatedResponse<SimplifiedClaimDto>.fromJson(
      _result.data!,
      (json) => SimplifiedClaimDto.fromJson(json as Map<String, dynamic>),
    );
    return value;
  }
