...
DetailedQuoteDto _$DetailedQuoteDtoFromJson(Map<String, dynamic> json) {
  return _DetailedQuoteDto.fromJson(json);
}

/// @nodoc
mixin _$DetailedQuoteDto {
  ...
  List<QuoteItemDto> get items => throw _privateConstructorUsedError;
  ...
  QuoteStatusDto get status => throw _privateConstructorUsedError;
  ...
  @JsonKey(ignore: true)
  $DetailedQuoteDtoCopyWith<DetailedQuoteDto> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $DetailedQuoteDtoCopyWith<$Res> {
  factory $DetailedQuoteDtoCopyWith(
          DetailedQuoteDto value, $Res Function(DetailedQuoteDto) then) =
      _$DetailedQuoteDtoCopyWithImpl<$Res, DetailedQuoteDto>;
  @useResult
  $Res call(
      {int quotationId,
      int erpContractId,
...
/// @nodoc
class _$DetailedQuoteDtoCopyWithImpl<$Res, $Val extends DetailedQuoteDto>
    implements $DetailedQuoteDtoCopyWith<$Res> {
  _$DetailedQuoteDtoCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$DetailedQuoteDtoImplCopyWith<$Res>
    implements $DetailedQuoteDtoCopyWith<$Res> {
  factory _$$DetailedQuoteDtoImplCopyWith(_$DetailedQuoteDtoImpl value,
          $Res Function(_$DetailedQuoteDtoImpl) then) =
      __$$DetailedQuoteDtoImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {int quotationId,
...
/// @nodoc
class __$$DetailedQuoteDtoImplCopyWithImpl<$Res>
    extends _$DetailedQuoteDtoCopyWithImpl<$Res, _$DetailedQuoteDtoImpl>
    implements _$$DetailedQuoteDtoImplCopyWith<$Res> {
  __$$DetailedQuoteDtoImplCopyWithImpl(_$DetailedQuoteDtoImpl _value,
      $Res Function(_$DetailedQuoteDtoImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$DetailedQuoteDtoImpl(
      quotationId: null == quotationId
          ? _value.quotationId
          : quotationId // ignore: cast_nullable_to_non_nullable
              as int,
...
/// @nodoc
@JsonSerializable()
class _$DetailedQuoteDtoImpl implements _DetailedQuoteDto {
  const _$DetailedQuoteDtoImpl(
      ...
      required final List<QuoteItemDto> items,
  ...
  factory _$DetailedQuoteDtoImpl.fromJson(Map<String, dynamic> json) =>
      _$$DetailedQuoteDtoImplFromJson(json);
  ...
  final List<QuoteItemDto> _items;
  @override
  List<QuoteItemDto> get items {
...
// Todo(jesus): change when we have the dto from the backend
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$DetailedQuoteDtoImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$DetailedQuoteDtoImplCopyWith<_$DetailedQuoteDtoImpl> get copyWith =>
      __$$DetailedQuoteDtoImplCopyWithImpl<_$DetailedQuoteDtoImpl>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$DetailedQuoteDtoImplToJson(
      this,
    );
  }
}

abstract class _DetailedQuoteDto implements DetailedQuoteDto {
  const factory _DetailedQuoteDto(
      ...
      required final QuoteStatusDto status,
      required final int serialNumberId,
      required final List<FileAttachmentDto> attachments,
      required final dynamic subtotalVatAmount}) = _$DetailedQuoteDtoImpl;

  factory _DetailedQuoteDto.fromJson(Map<String, dynamic> json) =
      _$DetailedQuoteDtoImpl.fromJson;
