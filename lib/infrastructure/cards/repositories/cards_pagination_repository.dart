...
class CardsPaginationRepository extends PaginationRepository<SimplifiedCard> {
  CardsPaginationRepository(this._repository);

  final CardsRepository _repository;

  @override
  Future<List<SimplifiedCard>?> fetchPage({required int page, required int pageSize}) async {
