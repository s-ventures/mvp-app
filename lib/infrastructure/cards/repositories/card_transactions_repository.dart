...
final simplifiedCardTransactionsRepositoryProvider = Provider<CardTransactionsRepository>(
  (ref) => CardTransactionsRepository(
    remoteDataSource: CardTransactionsRemoteDataSource(ref.watch(cardTransactionsRestClientProvider)),
  ),
);

class CardTransactionsRepository implements ICardTransactionsRepository {
  CardTransactionsRepository({required CardTransactionsRemoteDataSource remoteDataSource})
