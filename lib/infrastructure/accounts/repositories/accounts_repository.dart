...
import 'package:manifiesto_mvp_app/infrastructure/accounts/data_sources/local/accounts_local_data_source.dart';
import 'package:manifiesto_mvp_app/infrastructure/accounts/data_sources/remote/accounts_remote_data_source.dart';
...
class AccountsRepository implements IAccountsRepository {
  ...
  @override
  Future<Either<SelectAccountFailure, Unit>> selectAccount({required int accountId}) async {
    try {
  ...
  @override
  Future<Either<DetailedAccountFailure, DetailedAccount>> getDetailedAccount({required int accountId}) async {
    try {
      final response = await _remoteDataSource.getDetailedAccount(accountId: accountId.toString());
