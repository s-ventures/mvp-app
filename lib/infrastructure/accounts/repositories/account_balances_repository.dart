...
import 'package:manifiesto_mvp_app/infrastructure/accounts/data_sources/remote/account_balances_remote_data_source.dart';
...
final accountBalancesRepositoryProvider = Provider<AccountBalancesRepository>(
  (ref) => AccountBalancesRepository(
    remoteDataSource: AccountBalancesRemoteDataSource(ref.watch(accountBalancesRestClientProvider)),
  ),
);
