...
class ContactDetailsRevenueTab extends StatelessWidget {
  const ContactDetailsRevenueTab({super.key});
          ...
          child: Column(
            ...
            children: [
              Row(
                ...
                children: [
                  Text(
                    1456.00.toCurrency(plusSign: false),
              ...
              LineBarChart(
                ...
                redValue: 16,
                redLabel: context.loc.commonOverdue,
              ),
            ],
          ),
        ),
