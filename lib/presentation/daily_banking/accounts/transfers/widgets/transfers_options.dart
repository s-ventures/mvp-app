          ...
          children: [
            Splash(
              child: ListTile(
                ...
                onTap: () => context.pushNamed(AppRoute.dailyBankingNationalTransfers.name),
              ),
            ),
            Splash(
              child: ListTile(
                ...
                trailing: IconSvg.small(IconAssets.chevronRight),
                onTap: () => context.pushNamed(AppRoute.dailyBankingInternationalTransfers.name),
              ),
            ),
            Splash(
              borderRadius: BorderRadius.only(
              ...
              child: ListTile(
                ...
                onTap: () => context.pushNamed(AppRoute.dailyBankingSoonPay.name),
              ),
            ),
          ],
        ),
