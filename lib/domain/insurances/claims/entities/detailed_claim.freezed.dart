...
/// @nodoc
class _$DetailedClaimCopyWithImpl<$Res, $Val extends DetailedClaim>
    implements $DetailedClaimCopyWith<$Res> {
  _$DetailedClaimCopyWithImpl(this._value, this._then);
...
/// @nodoc
class __$$DetailedClaimImplCopyWithImpl<$Res>
    extends _$DetailedClaimCopyWithImpl<$Res, _$DetailedClaimImpl>
    implements _$$DetailedClaimImplCopyWith<$Res> {
  __$$DetailedClaimImplCopyWithImpl(
      _$DetailedClaimImpl _value, $Res Function(_$DetailedClaimImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$DetailedClaimImpl(
      id: null == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as UniqueId,
...
class _$DetailedClaimImpl implements _DetailedClaim {
  const _$DetailedClaimImpl(
      {required this.id,
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$DetailedClaimImplCopyWith<_$DetailedClaimImpl> get copyWith =>
      __$$DetailedClaimImplCopyWithImpl<_$DetailedClaimImpl>(this, _$identity);
}
