...
part of 'card_transactions_filter.dart';
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      cardContractIds: null == cardContractIds
          ? _value.cardContractIds
          : cardContractIds // ignore: cast_nullable_to_non_nullable
              as List<UniqueId>,
...
class _$CardTransactionsFilterImpl implements _CardTransactionsFilter {
  ...
  final List<UniqueId> _cardContractIds;
  @override
  List<UniqueId> get cardContractIds {
    if (_cardContractIds is EqualUnmodifiableListView) return _cardContractIds;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(_cardContractIds);
  }

  final List<UniqueId> _cardIds;
  @override
...
abstract class _CardTransactionsFilter
    implements CardTransactionsFilter, IPaginationFilter {
