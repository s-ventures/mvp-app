...
part of 'simplified_periodic_order.dart';
...
/// @nodoc
mixin _$SimplifiedPeriodicOrder {
...
class _$SimplifiedPeriodicOrderImpl implements _SimplifiedPeriodicOrder {
  const _$SimplifiedPeriodicOrderImpl(
      {required this.id,
...
abstract class _SimplifiedPeriodicOrder implements SimplifiedPeriodicOrder {
  const factory _SimplifiedPeriodicOrder(
