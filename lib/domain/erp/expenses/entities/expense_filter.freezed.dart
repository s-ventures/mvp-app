...
class _$ExpenseFilterImpl implements _ExpenseFilter {
  ...
  @override
  String toString() {
    return 'ExpenseFilter(id: $id, stakeholderId: $stakeholderId, createdDateFrom: $createdDateFrom, createdDateTo: $createdDateTo, issueDateFrom: $issueDateFrom, issueDateTo: $issueDateTo, totalAmountFrom: $totalAmountFrom, totalAmountTo: $totalAmountTo, query: $query, status: $status)';
  }
...
abstract class _ExpenseFilter implements ExpenseFilter, PaginationFilter {
  const factory _ExpenseFilter(
      ...
      final double? totalAmountTo,
      final String? query,
      final ExpenseStatus? status}) = _$ExpenseFilterImpl;
